...
// node_modules/.pnpm/redux-actions@3.0.0/node_modules/redux-actions/dist/redux-actions.js
function m(n, e, ...t) {
...
var l = (n) => typeof n == "function";
var z = (n) => typeof n == "symbol" || typeof n == "object" && Object.prototype.toString.call(n) === "[object Symbol]";
var P = (n) => n.length === 0;
var j = (n) => n.toString();
var w = (n) => typeof n == "string";
var C = "/";
var h = "||";
function D(n) {
  return w(n) || l(n) || z(n);
...
var x = (n) => Array.isArray(n);
var T = (n) => n == null;
var Z = (n) => n[n.length - 1];
var K = /\s/;
var _ = /([-.:_])/;
var q = /([a-z][A-Z]|[A-Z][a-z])/;
var O = "/";
var G = /[\W_]+(.|$)/g;
var Y = (n) => n.replace(G, (e, t) => t ? " " + t : "");
var B = /(.)([A-Z]+)/g;
var H = (n) => n.replace(
  B,
  (e, t, o) => t + " " + o.toLowerCase().split("").join(" ")
);
var J = (n) => K.test(n) ? n.toLowerCase() : _.test(n) ? (Y(n) || n).toLowerCase() : q.test(n) ? H(n).toLowerCase() : n.toLowerCase();
var Q = (n) => J(n).replace(/[\W_]+(.|$)/g, (e, t) => t ? " " + t : "").trim();
var I = (n) => Q(n).replace(
  /\s(\w)/g,
  (e, t) => t.toUpperCase()
);
var R = (n) => n.includes(O) ? n.split(O).map(I).join(O) : I(n);
var S = (n, e) => n.reduce(
  (t, o) => e(t, o),
  {}
);
var b = (n) => typeof Map < "u" && n instanceof Map;
function $(n) {
  if (b(n))
...
var M = (n) => function e(t, { namespace: o = C, prefix: s } = {}, c = {}, r = "") {
  function i(f) {
    if (!r)
      return f;
