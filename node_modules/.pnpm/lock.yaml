...
dependencies:
  ...
  redux-first-history:
    specifier: ^5.1.1
    version: 5.1.1(history@5.3.0)(redux@4.2.1)
  redux-immer:
    specifier: ^1.0.5
    version: 1.0.5
  redux-persist:
  ...
  redux-saga-routines:
    specifier: ^3.2.3
    version: 3.2.3(@babel/runtime@7.22.15)(redux-saga@1.2.3)
  reselect:
    specifier: ^4.1.8
    version: 4.1.8
  sort-by:
...
packages:
  ...
  /react-redux@8.1.2(@types/react-dom@18.2.7)(@types/react@18.2.21)(react-dom@18.2.0)(react@18.2.0)(redux@4.2.1):
  ...
  /redux-actions@3.0.0:
    resolution: {integrity: sha512-5r+G8JizsTfyfWolVDkCLL2SpZA0Sk9ao2MXwfdXkG5+72s0PcO9qEqpo51D2o8dZY2gXLjNmY5yoRB+BuizRw==}
    dependencies:
      just-curry-it: 5.3.0
      reduce-reducers: 1.0.4
    dev: false

  /redux-first-history@5.1.1(history@5.3.0)(redux@4.2.1):
    resolution: {integrity: sha512-ujVHv+y9wC2rqavS5tLiSu6zkw+VYrEea+/ggwVTRuutadEtwxSRlaK19ry/PTLSQtFuUF1Xu+plL5erD4roVw==}
    peerDependencies:
      history: ^4.7.2 || ^5.0
      redux: ^3.6.0 || ^4.0.0
    dependencies:
  ...
  /redux-immer@1.0.5:
    resolution: {integrity: sha512-sjYgK2a7aFm0Mx8dmBZ3jfSjIsWmPqIkVjQQIn7VLiDPMNrphjcAIZ8C3L75LxidkJDolHcj/MSbBVlllO/CXg==}
    dev: false
  ...
  /redux-saga-routines@3.2.3(@babel/runtime@7.22.15)(redux-saga@1.2.3):
    resolution: {integrity: sha512-mUaVAk8ZMXIYv28kUgtAg9p9e6A1We+GLjSnSaj+fmAzwn8+NPlxVNqQ85R7BEzc/F6d5nQDcoh72yCaxcLpZA==}
    peerDependencies:
      '@babel/runtime': '>=7.0.0'
      redux-saga: '>=0.15.0'
    dependencies:
